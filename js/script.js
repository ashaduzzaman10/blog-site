...
$(document).ready(function () {
  ...
  $(".cfull").on("click", function () {
    if (screenfull.isFullscreen) {
      ...
      elback.style.maxHeight =
        parseInt(screen.height) - (parseInt(hcontrol) + 10) + "px";
  ...
  $(".play-button .fa,.cplay").on("click", function () {
    var opening = "image/frontback.jpg",
      loading =
        "//" + window.location.hostname + pathloc + "image/player-loading.gif";
    $(".play-button .fa").hide();
    $(".player-loader").show();
    setTimeout(function () {
